...
-- windows
map("n", "<leader>zw", "<C-W>p", { desc = "Other window", remap = true })
map("n", "<leader>zd", "<C-W>c", { desc = "Delete window", remap = true })
map("n", "<leader>z-", "<C-W>s", { desc = "Split window below", remap = true })
map("n", "<leader>z|", "<C-W>v", { desc = "Split window right", remap = true })
